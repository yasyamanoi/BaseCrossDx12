	...
	for(PfxUInt32 i=0;i<numJoints;i++) {
		...
		switch(joint.m_type){
			...
			case kPfxJointSlider:
				...
				endpt = wFrameA.getCol2() * 0.2f * m_scale;
				m_renderLineFunc(vlow+endpt,vlow-endpt, PfxVector3(0.5f,0.0f,0.8f));
				m_renderLineFunc(vup+endpt, vup-endpt,  PfxVector3(0.5f,0.0f,0.8f));			
				break;
